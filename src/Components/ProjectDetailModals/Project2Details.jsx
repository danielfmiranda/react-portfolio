...
class Project2Details extends Component {
    render() {
        return (
            <Modal show={this.props.activeProject === 2 ? (true) : (false)}
            ...
            >
                ...
                <Modal.Body closeButton>
                    <div className={'projectDetailsInfo'}>
                        ...
                        <h1 className={'projectDetailsTitle'}>Name of Project2</h1>
